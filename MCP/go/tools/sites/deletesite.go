...
func DeletesiteHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.DeleteSiteOutput
...
func CreateDeletesiteTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_sites_SiteId",
		mcp.WithDescription("Deletes the specified site."),
		mcp.WithString("SiteId", mcp.Required(), mcp.Description(" The ID or the Amazon Resource Name (ARN) of the site. ")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    DeletesiteHandler(cfg),
	}
}
