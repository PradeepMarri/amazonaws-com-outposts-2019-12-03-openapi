...
func UpdatesiteHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.UpdateSiteOutput
...
func CreateUpdatesiteTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_sites_SiteId",
		mcp.WithDescription("Updates the specified site."),
		...
		mcp.WithString("Name", mcp.Description("Input parameter: The name of the site.")),
		mcp.WithString("Notes", mcp.Description("Input parameter: Notes about a site.")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    UpdatesiteHandler(cfg),
	}
}
