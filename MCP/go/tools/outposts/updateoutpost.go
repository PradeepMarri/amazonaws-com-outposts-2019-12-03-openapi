...
func UpdateoutpostHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.UpdateOutpostOutput
...
func CreateUpdateoutpostTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_outposts_OutpostId",
		mcp.WithDescription(" Updates an Outpost. "),
		...
		mcp.WithString("Name", mcp.Description("Input parameter: The name of the Outpost.")),
		mcp.WithString("SupportedHardwareType", mcp.Description("Input parameter:  The type of hardware for this Outpost. ")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    UpdateoutpostHandler(cfg),
	}
}
