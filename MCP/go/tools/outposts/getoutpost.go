...
func GetoutpostHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GetOutpostOutput
...
func CreateGetoutpostTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_outposts_OutpostId",
		mcp.WithDescription("Gets information about the specified Outpost."),
		mcp.WithString("OutpostId", mcp.Required(), mcp.Description(" The ID or the Amazon Resource Name (ARN) of the Outpost. ")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    GetoutpostHandler(cfg),
	}
}
