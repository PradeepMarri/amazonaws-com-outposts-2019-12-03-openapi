...
func GetoutpostinstancetypesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/outposts/%s/instanceTypes%s", cfg.BaseURL, OutpostId, queryString)
		...
		var result models.GetOutpostInstanceTypesOutput
...
func CreateGetoutpostinstancetypesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_outposts_OutpostId_instanceTypes",
		mcp.WithDescription("Gets the instance types for the specified Outpost."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    GetoutpostinstancetypesHandler(cfg),
	}
}
